...
const DEFAULT_ACCENT = "#f59e0b" // amber accent for novels
const TYPE_LABEL = "NOVEL"
...
export async function GET(req: NextRequest) {
  try {
    ...
    // Example call:
    // /api/novel-embed?title=Your+Title&cover=...&banner=...&tags=Isekai|Drama|Ongoing&themecolor=f59e0b
